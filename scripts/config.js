...
async function registerConfig() {
    bot.commands = new (require('../build/core/collections/CommandCollection').CommandCollection)(bot);
    bot.modules = new (require('../build/core/collections/ModuleCollection').ModuleCollection)(bot);
    bot.modules.load();
