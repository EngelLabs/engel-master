...
class Core extends eventemitter3_1.EventEmitter {
    constructor() {
        super();
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.log(`Starting ${baseConfig_1.default.name}(env=${baseConfig_1.default.env} s=${baseConfig_1.default.client.state}, v=${baseConfig_1.default.version}).`, 'info');
